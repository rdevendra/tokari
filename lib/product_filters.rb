  ...
  module Core
    ...
    module ProductFilters
      ...
      def ProductFilters.price_filter
        ...
        conds = [ [ Spree.t(:under_price, price: format_price(200))     , v[:amount].lteq(200)],
                  [ "#{format_price(200)} - #{format_price(500)}"        , v[:amount].in(200..500)],
                  [ "#{format_price(500)} - #{format_price(1000)}"        , v[:amount].in(500..1000)],
                  [ "#{format_price(1000)} - #{format_price(2000)}"        , v[:amount].in(1000..20000)],
